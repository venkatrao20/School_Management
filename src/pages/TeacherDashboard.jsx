      ...
      <div className="dashboard-content">
        ...
        <div className="admin-nav-grid">
          ...
          <div className="admin-nav-card" onClick={() => navigate("/teacher/syllabus")}>
            <h3>Syllabus / Lesson Plan</h3>
            <p>Track chapter-wise syllabus coverage for your classes and subjects.</p>
          </div>
          <div className="admin-nav-card" onClick={() => navigate("/teacher/academic-calendar")}>
            <h3>Academic Calendar</h3>
            <p>View school holidays, exams, PTMs and events for the academic year.</p>
          </div>
          <div className="admin-nav-card" onClick={() => navigate("/teacher/profile")}>
            <h3>My Profile</h3>
