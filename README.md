...
The repository now has a root React/Vite frontend and a root Node/Express API
foundation. The API is configured for Railway MySQL through the `MYSQL*`
environment variables and serves the built frontend in production.
